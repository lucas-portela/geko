...
exports.$flow = exports.$exp = exports.$transform = exports.$named = exports.$plex = exports.$wire = exports.$gene = exports.$kodo = void 0;
var flow_1 = require("./flow");
var gene_1 = require("./gene");
var kodo_1 = require("./kodo");
var wire_1 = require("./wire");
var $kodo = function (fn) {
    return function (input, output) {
        return new kodo_1.Kodo({ genes: function () { return fn({ input: input !== null && input !== void 0 ? input : {}, output: output !== null && output !== void 0 ? output : {} }); } });
    };
};
exports.$kodo = $kodo;
