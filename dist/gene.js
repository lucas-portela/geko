...
var Gene = /** @class */ (function (_super) {
    ...
    Gene.prototype.write = function (key, value) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._readyPromise];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, _super.prototype.write.call(this, key, value)];
                }
            });
        });
    };
    Gene.prototype.init = function (kodo) {
        var _this = this;
        this._readyPromise = new Promise(function (resolve) { return (_this._readyResolver = resolve); });
        this._isReady = false;
        this._kodo = kodo;
